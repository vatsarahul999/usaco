...
class beads {
	...
	public static void main(String[] args) throws Exception {
		...
		int N = 29;
		String allBeads = "wwwbbrwrbrbrrbrbrwrwwrbwrwrrb";
		allBeads += allBeads;
		...
		for (int i = 0; i < 2 * N; i++) {
			...
			System.out.println("The max is forward max " + forwardMax);
			currentChar = 'w';
			int backwardMax = 0;
			v = 0;
			for (int k = i - 1; k >= 0; k--) {
			...
			System.out.println("The max is backward max " + backwardMax);
